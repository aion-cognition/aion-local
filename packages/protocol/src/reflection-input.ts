 ...
 * stays a string. `occurred_at` is PLAN P1-4's per-item timestamp: intake uses it when the
 * caller supplies it, else the wall clock at write time.
 */
 ...
 * call actually carried, string or structured — redaction (PLAN P1-2) walks either shape.
 */
