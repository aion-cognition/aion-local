 ...
 * quantum query the cues themselves were correct, which puts the failure downstream of cue
...
/**
 * Four measured summaries against one query, verbatim, with the rank the answer came back at.
...
export type SummaryToneFixture = {
  ...
  /** What `SUMMARY_TONE_QUERY` measured under this summary. */
