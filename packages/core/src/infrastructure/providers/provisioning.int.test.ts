...
describe('provisionOllama against live host Ollama', () => {
  it('streams a pull and a round-trip verification for every configured model', async () => {
  ...
  it('names the model when a pull cannot be satisfied', async () => {
    await expect(
